    ...
    <aside class="panel legend-panel">
      ...
      <div class="legend-section">
        ...
        <ul class="legend-glyph-list">
          <li class="legend-glyph-row"><img class="legend-glyph" src="../../../design/glyphs/S.svg" alt="Story glyph"><span>Story</span></li>
          <li class="legend-glyph-row"><img class="legend-glyph" src="../../../design/glyphs/A.svg" alt="Annotation glyph"><span>Annotation</span></li>
          <li class="legend-glyph-row"><img class="legend-glyph" src="../../../design/glyphs/I.svg" alt="Input glyph"><span>User Input</span></li>
          <li class="legend-glyph-row"><img class="legend-glyph" src="../../../design/glyphs/Nds.svg" alt="Nds glyph"><span>Data Story</span></li>
          <li class="legend-glyph-row"><img class="legend-glyph" src="../../../design/glyphs/V.svg" alt="Visualization glyph"><span>Visualization</span></li>
        </ul>
        <div class="legend-indent">
          <div class="legend-subtitle">How User Input gets visible</div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vh.svg" alt="Highlight glyph"><div>Highlight in visualization</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vu.svg" alt="Update glyph"><div>Update in visualization</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vz.svg" alt="Zoom glyph"><div>Zoom in visualization</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vcu.svg" alt="Comparison glyph"><div>Comparison user vs herself</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vcuu.svg" alt="User vs users glyph"><div>Comparison user vs users</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vcuo.svg" alt="User vs official glyph"><div>Comparison user vs official</div></div>
          <div class="legend-subitem"><img class="legend-glyph" src="../../../design/glyphs/Vcuuo.svg" alt="User vs users vs official glyph"><div>Comparison user vs users vs official</div></div>
        </div>
      </div>
      <div class="legend-section">
        ...
        <div class="legend-concept legend-flow">
          <div class="legend-align-row">
            <div class="legend-icon-cell vertical">
              <img class="legend-glyph" src="../../../design/glyphs/V.svg" alt="V">
              <img class="legend-glyph" src="../../../design/glyphs/A.svg" alt="A">
            </div>
